        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2">
                    <form action="{{route('user.transaction.update',base64_encode($transaction->id))}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <div class="input-group input-group-outline mb-3 mx-3 other-text d-none is-filled">
                                    ...
                                    <input type="text" name="other_text" id="other_text" value="{{$transaction->other_text}}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
